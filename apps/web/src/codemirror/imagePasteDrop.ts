...
async function insertImages(
  ...
  files: File[],
  pos?: number,
  onResolve?: (files: File[], dataUrls: string[]) => Promise<string[] | void>
) {
...
export function imagePasteDrop(options?: {
  onResolveUrls?: (files: File[], dataUrls: string[]) => Promise<string[] | void>;
}) {
